...
function spawnFruit(){
  ...
  active.push({el:img,x,y:startY,vx,vy,rot,type:name});
}
...
function lineIntersectsRect(p1,p2,r){
  if((p1.x<r.left&&p2.x<r.left)||(p1.x>r.right&&p2.x>r.right)||(p1.y<r.top&&p2.y<r.top)||(p1.y>r.bottom&&p2.y>r.bottom))return false;
  return true;
}
